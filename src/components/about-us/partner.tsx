        ...
        <div className='w-full h-[700px] relative overflow-hidden'>
            ...
            <div className='absolute inset-0 w-full h-full lg:pt-20'>
                <div className='flex items-center justify-center h-full'>
                    <div>
                        <figure className='w-[120px] h-[120px] lg:w-[205px] lg:h-[205px] mx-auto mb-20'>
                            <Image src={badge} alt='' />
                        </figure>
                        <div>
                            <p style={{
                            ...
                            <div className='mx-auto w-[254px]' >
                                <BtnPrimary onClick={handleShowToast} text={t("partner.button")} variant={'primary-lighter'} />
                            </div>
                        </div>
                    </div>
                </div>
