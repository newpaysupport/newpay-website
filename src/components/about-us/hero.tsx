...
const Hero = () => {
    ...
    return (
        <div className='relative w-full h-[800px] lg:h-[calc(100vh-70px)]'>
            ...
            <div className='relative z-[1] w-full h-full pt-20 pb-12 lg:pb-[143px]'>
                <BoxWrapped className="h-full">
                    <div className='w-full h-full flex flex-col justify-end xl:px-20'>
