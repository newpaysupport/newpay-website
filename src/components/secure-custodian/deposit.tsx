    ...
    return (
        <div className='bg-[#000] pt-10 lg:py-20'>
            <div className='container mx-auto relative h-[750px]'>
                <Image src={bgDeposit} alt='' fill priority objectFit='contain' className='mix-blend-lighten hidden lg:block' />
                <Image src={bgDepositMobile} alt='' fill priority objectFit="contain" className='mix-blend-lighten lg:hidden h-full' />
