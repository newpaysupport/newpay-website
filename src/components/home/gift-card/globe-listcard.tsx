...
import card4_mobile from '@/images/home/giftcard/card.png'
    ...
    return (
        <div className='bg-[#060606] relative'>
            <div className='pt-60'>
                ...
                {/* Desktop */}
                <div className='absolute right-0 left-0 top-[20%] bottom-0 md:flex gap-5 items-start justify-center hidden'>
                ...
                <div className='absolute inset-0 bottom-0 left-0 md:flex items-end justify-center hidden'>
                    <div>
