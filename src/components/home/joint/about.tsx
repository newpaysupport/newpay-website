            ...
            <div className="relative w-full h-[500px] md:h-[750px]">
                ...
                >
                    ...
                    <>
                        ...
                        <Image src={about_joint} alt='' className='absolute md:h-[640px] md:w-[1200px] top-[60%] right-[8%] left-[8%] visible rounded-4xl mx-auto object-cover object-center hidden md:block' />
                        <Link href={`/${locale}/contact`}>
