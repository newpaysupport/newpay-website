            ...
            <div className="relative w-full h-[500px] md:h-[750px]">
                ...
                >
                    {isMobile ? (
                        //mobile
                        <>
                            <div className="absolute inset-0 flex flex-col mt-20 justify-start items-center text-center gap-4 px-4">
                            ...
                            <Image src={about_joint} alt='' className='absolute rounded-3xl bottom-[-45%] left-1/2 transform -translate-x-1/2 object-cover object-center h-[400px] w-[400px]' />
                            <Link href={`/${locale}/contact`}>
                                <button className='absolute bottom-[-42%] right-[10%] p-2 text-[#060606] bg-[#FFF] flex gap-2 items-center rounded-full group'>
