...
export default function TermsAndConditions() {
  ...
  return (
    <div className="bg-black lg:pt-0 pt-30">
      ...
      <div className="container lg:pt-0 lg:px-0 pt-8 mx-auto flex flex-col lg:flex-row gap-8 text-sm">
        {/* Sidebar */}
