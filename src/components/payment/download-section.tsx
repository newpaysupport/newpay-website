...
const DownloadSection = () => {
    ...
    return (
        <section className="bg-[#060606]">
            <div className="bg-[#FFFFFF]/4 rounded-[24px] lg:rounded-[80px]">
                <BoxWrapped className=" lg:py-20 lg:px-30 px-6 py-12 ">
                    <div className="flex lg:flex-row flex-col-reverse mx-auto lg:gap-30 lg:justify-center items-center">
