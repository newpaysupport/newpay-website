...
import bgGradientMobile from '@/images/faq-help/gradient-mobile.png';
...
const NeedAHand = () => {
    ...
    return (
        <div className='h-[400px] relative bg-[#060606]'>
            <Image src={bgGradient} alt='' fill className='w-full h-full hidden lg:block' />
            <Image src={bgGradientMobile} alt='' fill className='w-full h-full lg:hidden' />
            <div className='relative z-[1] container mx-auto flex flex-col justify-end items-center pb-10 w-full h-full px-6 lg:px-0'>
                ...
                <div
                    ...
                    className='w-full lg:w-[480px] mx-auto h-[72px] bg-white/8 rounded-2xl box-border p-6 flex items-center gap-x-[10px]'>
                    <figure>
