...
const FaqInfo = ({ searchTerm }: { searchTerm: string }) => {
        ...
        <div className='bg-[#060606]'>
            <div className='container mx-auto'>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-3'>
                    {!filteredFaqs.length ? <p className='text-white text-lg font-semibold text-center col-span-1 md:col-span-2'>{t("noResult")}</p> : filteredFaqs.map((item, index) => {
                        return (
