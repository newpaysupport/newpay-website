            ...
            <div className={`flex flex-col ${CardBg === false ? '' : 'hover:bg-orange-50 hover:border border-orange-100 p-3'} rounded-3xl group`}>
                ...
                <div className="w-full flex flex-col justify-between mt-4">
                    ...
                    <div className="flex items-center gap-2">
                        <span className="text-sm font-medium border border-gray-300 rounded-full px-4 py-2">{tags?.at(1)}</span>
                        <span className="text-sm font-medium border border-gray-300 rounded-full px-4 py-2">{tags?.at(0)}</span>
